    ...
    return(
         ...
         <form className="formcontainer" onSubmit={handleSubmit} onReset={handleReset}>
            <div className="nameboxs">
                <label className="namebox1" htmlFor="namefld">Name:</label>
            ...
            <div className="passwdbox">
                <label className="namebox1" htmlFor="passfld">Password:</label>
            ...
            <div className="genderbox">
                <label className="namebox1" htmlFor="gender">Gender:</label>
                <div id="gender">
            ...
            <div className="branchbox">
                <label className="namebox1" htmlFor="branch">Branch:</label>
                <select className="namebox" id="branch" onChange={handleBranch}>
                    <option className='b1'>Select One</option>
                    <option className='b1'>Automobile</option>
                    <option className='b1'>Civil</option>
                    <option className='b1'>Computer Science</option>
                    <option className='b1'>Electronics & Communication</option>
                    <option className='b1'>Mechanical</option>
                </select>
                <span style={{color:'red'}}>{err_branch?"Select Branch.":''}</span>
            </div>
            <div className="addbox">
                <label className="namebox1" htmlFor="address">Address:</label>
            ...
            <div className="imagebox">
                <label className="namebox1" htmlFor="image">Photo:</label>
            ...
            <div className="interestsbox">
                <label className="namebox1" htmlFor="interests">Interests:</label>
                <div className="interests">
                  ...
                  <input type="checkbox" className="namebox" value="Coding" checked={intr.Reading} onChange={handleIntr}/>Coding{'\u0020'}
